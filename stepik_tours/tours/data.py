description = """Лучшие направления AAA где никто не будет вам мешать сидеть на берегу и изучать программирование,
...
gen_info = {"title": "Stepik Travel", "subtitle": "Для тех, кого отвлекают дома", "descriprion": description}
